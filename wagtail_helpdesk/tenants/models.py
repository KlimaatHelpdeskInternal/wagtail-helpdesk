...
class Tenant(models.Model):
    ...
    sitename = models.CharField(_("sitename"), max_length=50)
    ...
    logo = models.ForeignKey(
        ...
        related_name="+",
        help_text=_(
            "This is the logo used for display the tenant"
        ),
    )
    logofooter = models.ForeignKey(
        ...
        related_name="+",
        help_text=_(
            "This is the logo used in the footer for display the tenant"
        ),
    )
    ...
    panels = [
        FieldPanel("id", read_only=True, help_text=_("The ID of this Tenant, you can use it in the environment settings")),
        FieldPanel("name", help_text=_("The name is used to identify the tenant, it has no functional implications")),
        FieldPanel("description", help_text=_("The description is used to describe the tenant, it has no functional implications")),
        FieldPanel("sitename", help_text=_("The sitename is used as the title for webpages")),
        FieldPanel("logo", help_text=_("Image to be used as logo")),
        FieldPanel("logofooter", help_text=_("Image to be used as logo in the footer")),
